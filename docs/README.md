...
current capability. Code is authoritative for routing/configuration; executed
controls and revision-bound artifacts are authoritative for verification.

The pre-consolidation onboarding snapshot is in
[archive/onboarding-2026-09-19](../archive/onboarding-2026-09-19/INDEX.md).
It preserves existing uncommitted notes as well as older contradictory claims.
Do not load it as onboarding. There is no need to enumerate every archived report.
